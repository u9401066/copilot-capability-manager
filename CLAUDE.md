...
這是 **Copilot Capability Manager**，一個 VS Code 擴充套件專案，提供：
- 🧩 **Skill 管理**：視覺化管理 AI 技能模組
- 🔗 **Capability 建構**：組合 Skills 形成動態能力流程
- 🛤️ **Skill Pathway 驗證**：追蹤和驗證能力路徑效能
...
> **Capability ≠ Workflow**：Workflow 是線性的，Capability 支援迴圈和條件判斷。
